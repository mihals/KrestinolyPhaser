...
export class Crest{
    ...
    constructor(scene:Phaser.Scene){
        ...
        img = this.sc.add.image(286,586,'backCard140').setScale(0.7);
        img.setInteractive().setDataEnabled();
        this.bcCardsArr.push(img.setData({ind:0, card:0}))

        img = this.sc.add.image(396,586,'backCard140').setScale(0.7);;
        img.setInteractive().setDataEnabled();
        this.bcCardsArr.push(img.setData({ind:1, card:0}))

        img = this.sc.add.image(176,696,'backCard140').setScale(0.7);;
        img.setInteractive().setDataEnabled();
        this.bcCardsArr.push(img.setData({ind:2, card:0}))

        img = this.sc.add.image(286,696,'backCard140').setScale(0.7);;
        img.setInteractive().setDataEnabled();
        this.bcCardsArr.push(img.setData({ind:3, card:0}))

        img = this.sc.add.image(396,696,'backCard140').setScale(0.7);;
        img.setInteractive().setDataEnabled();
        this.bcCardsArr.push(img.setData({ind:4, card:0}))

        img = this.sc.add.image(506,696,'backCard140').setScale(0.7);;
        img.setInteractive().setDataEnabled();
        this.bcCardsArr.push(img.setData({ind:5, card:0}))

        img = this.sc.add.image(286,806,'backCard140').setScale(0.7);;
        img.setInteractive().setDataEnabled();
        this.bcCardsArr.push(img.setData({ind:6, card:0}))

        img = this.sc.add.image(396,806,'backCard140').setScale(0.7);;
        img.setInteractive().setDataEnabled();
        this.bcCardsArr.push(img.setData({ind:7, card:0}))

        img = this.sc.add.image(286,916,'backCard140').setScale(0.7);;
        img.setInteractive().setDataEnabled();
        this.bcCardsArr.push(img.setData({ind:8, card:0}))

        img = this.sc.add.image(396,916,'backCard140').setScale(0.7);;
        img.setInteractive().setDataEnabled();
        this.bcCardsArr.push(img.setData({ind:8, card:0}))
    ...
    addCard(ind:number){
        ...
        switch(ind){
            case 0:
                // проверяем по вертикали на тройной ряд
                if (this.bcCardsArr[3].data.values.card != 0 &&
                    ...
                    // проверяем по вертикали на четверной ряд
            ...
            // проверяем по горизонтали на тройной ряд
            case 2:
                if(this.bcCardsArr[3].data.values.card != 0 &&
                    ...
                    // проверяем по горизонтали на четверной ряд
            ...
            case 3:
                // проверяем по горизонтали на тройной ряд с ячейкой в центре
                ...
                // проверяем по горизонтали на тройной ряд с ячейкой слева
                if(this.bcCardsArr[4].data.values.card != 0 &&
                ...
                // проверяем по вертикали на тройной ряд с ячейкой в центре
                ...
                // проверяем по вертикали на тройной ряд с ячейкой сверху
                if(this.bcCardsArr[6].data.values.card != 0 &&
            ...
            case 4:
                ...
                // проверяем по горизонтали на тройной ряд с ячейкой справа
                if(this.bcCardsArr[2].data.values.card != 0 &&
            ...
            case 6:
                // проверяем по вертикали с ячейкой в центре на тройной ряд
                if(this.bcCardsArr[3].data.values.card != 0 &&
                    this.bcCardsArr[8].data.values.card != 0 &&
                    suit == this.getSuitByNum(this.bcCardsArr[3].data.values.card) &&
                    suit == this.getSuitByNum(this.bcCardsArr[8].data.values.card)){
                ...
                // проверяем по вертикали с ячейкой снизу на тройной ряд
                if(this.bcCardsArr[0].data.values.card != 0 &&
                    this.bcCardsArr[3].data.values.card != 0 &&
                    suit == this.getSuitByNum(this.bcCardsArr[0].data.values.card) &&
                    suit == this.getSuitByNum(this.bcCardsArr[3].data.values.card)){
            ...
            case 8:
                // проверяем вертикаль на тройной ряд
                if(this.bcCardsArr[6].data.values.card != 0 &&
                    this.bcCardsArr[3].data.values.card != 0 &&
                    suit == this.getSuitByNum(this.bcCardsArr[6].data.values.card) &&
                    suit == this.getSuitByNum(this.bcCardsArr[3].data.values.card)){
